...
rootpath = "C:\\Users\K.VARSHA\Desktop\music" #paste your music file path in this line
...
stopButton = tk.Button(ms,text="stop",image=stop_img,bg='black',borderwidth=0,command=stop)
...
pauseButton = tk.Button(ms, text="pause", image= pause_img, bg="black", borderwidth= 0, command = stop)
pauseButton.pack(pady=15, in_ = top, side = "left")

nextButton = tk.Button(ms, text="Next", image= next_img, bg="black", borderwidth= 0, command=  play_next)
